...
export async function POST(req) {
  ...
  // Extract locale from the frontend (defaults to English if missing)
...
* **Smart Search:** Provide a Google Maps search link exactly in this markdown format (replace the URL end with the specific court name and user's city with + signs for spaces):
[📍 Find this court on Google Maps](https://www.google.com/maps/search/?api=1&query=Insert+Court+Name+Here+City+Name+Here)
